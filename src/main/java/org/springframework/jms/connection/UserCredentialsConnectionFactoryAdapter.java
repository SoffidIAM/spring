...
public class UserCredentialsConnectionFactoryAdapter
	...
	public JMSContext createContext() {
		return this.targetConnectionFactory.createContext(this.username, this.password);
	}
	...
	public JMSContext createContext(int sessionMode) {
		return this.targetConnectionFactory.createContext(this.username, this.password, sessionMode);
	}
